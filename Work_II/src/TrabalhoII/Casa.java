...
public class Casa extends Imovel implements Serializable {
	...
	public Casa(String cor, Integer qtdComodos, String endereco) {
		super();
		this.cor = cor;
	...
	public String toString() {
		String aux = "A casa fica na(o) " + this.endereco + " a cor da casa é " + this.cor + " e tem " + this.qtdComodos + " cômodos.";
		return aux;
	}
